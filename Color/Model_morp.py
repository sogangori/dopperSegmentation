...
modelName = "./Color/weights/morp.pd"
LABEL_SIZE_C = 2
NUM_CHANNELS_In= 3
...
dil_filter = tf.constant(1.0, shape=[5,5,2])  
...
def inference(inData, train=False):
    ...
    pool = tf.nn.erosion2d(pool, dil_filter,[1,1,1,1],rates=[1,1,1,1], padding="SAME")
    pool = tf.nn.dilation2d(pool, dil_filter,[1,1,1,1],rates=[1,1,1,1], padding="SAME")

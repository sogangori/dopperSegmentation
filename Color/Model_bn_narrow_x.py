...
modelName = "./Color/weights/bn_narrow_x.pd"
LABEL_SIZE_C = 2
NUM_CHANNELS_In= 3
...
beta_m0 = tf.Variable(tf.constant(0.0, shape=[depth0*3]), trainable=True)
gamma_m0 = tf.Variable(tf.constant(1.0, shape=[depth0*3]), trainable=True)

conv_s0_weights = tf.get_variable("s0", shape=[3, 3, depth0*3, depth0*4], initializer =tf.contrib.layers.xavier_initializer())
beta_s0 = tf.Variable(tf.constant(0.0, shape=[depth0*4]), trainable=True)
gamma_s0 = tf.Variable(tf.constant(1.0, shape=[depth0*4]), trainable=True)

conv_t0_weights = tf.get_variable("t0", shape=[3, 3, depth0*4, depth0*5], initializer =tf.contrib.layers.xavier_initializer())
beta_t0 = tf.Variable(tf.constant(0.0, shape=[depth0*5]), trainable=True)
gamma_t0 = tf.Variable(tf.constant(1.0, shape=[depth0*5]), trainable=True) 

conv_p0_weights = tf.get_variable("p0", shape=[3, 3, depth0*5, depth0*6], initializer =tf.contrib.layers.xavier_initializer())
beta_p0 = tf.Variable(tf.constant(0.0, shape=[depth0*6]), trainable=True)
gamma_p0 = tf.Variable(tf.constant(1.0, shape=[depth0*6]), trainable=True) 

conv_x0_weights = tf.get_variable("x0", shape=[3, 3, depth0*6, depth0*7], initializer =tf.contrib.layers.xavier_initializer())
beta_x0 = tf.Variable(tf.constant(0.0, shape=[depth0*7]), trainable=True)
gamma_x0 = tf.Variable(tf.constant(1.0, shape=[depth0*7]), trainable=True) 

conv_xx0_weights = tf.get_variable("xx0", shape=[3, 3, depth0*7, depth0*7], initializer =tf.contrib.layers.xavier_initializer())
beta_xx0 = tf.Variable(tf.constant(0.0, shape=[depth0*7]), trainable=True)
gamma_xx0 = tf.Variable(tf.constant(1.0, shape=[depth0*7]), trainable=True) 

conv_x2_weights = tf.get_variable("x2", shape=[3, 3, depth0*7, depth0*6], initializer =tf.contrib.layers.xavier_initializer())
beta_x2 = tf.Variable(tf.constant(0.0, shape=[depth0*6]), trainable=True)
gamma_x2 = tf.Variable(tf.constant(1.0, shape=[depth0*6]), trainable=True) 

conv_p2_weights = tf.get_variable("p2", shape=[3, 3, depth0*6, depth0*5], initializer =tf.contrib.layers.xavier_initializer())
beta_p2 = tf.Variable(tf.constant(0.0, shape=[depth0*5]), trainable=True)
gamma_p2 = tf.Variable(tf.constant(1.0, shape=[depth0*5]), trainable=True)

conv_t2_weights = tf.get_variable("t2", shape=[3, 3, depth0*5, depth0*4], initializer =tf.contrib.layers.xavier_initializer())
beta_t2 = tf.Variable(tf.constant(0.0, shape=[depth0*4]), trainable=True)
gamma_t2 = tf.Variable(tf.constant(1.0, shape=[depth0*4]), trainable=True)

conv_s2_weights = tf.get_variable("s2", shape=[3, 3, depth0*4, depth0*3], initializer =tf.contrib.layers.xavier_initializer())
beta_s2 = tf.Variable(tf.constant(0.0, shape=[depth0*3]), trainable=True)
gamma_s2 = tf.Variable(tf.constant(1.0, shape=[depth0*3]), trainable=True)
...
beta_l2 = tf.Variable(tf.constant(0.0, shape=[depth0*1]), trainable=True)
gamma_l2 = tf.Variable(tf.constant(1.0, shape=[depth0*1]), trainable=True) 

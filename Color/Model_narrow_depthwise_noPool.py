...
modelName = "./Color/weights/depthwise3.pd"
...
def inference(inData, train=False):
    ...
    feature2 = pool = helper.conv2dReluStride2(pool,conv_m0_weights,conv_m0_biases,isDrop,keep_prop)        
    feature3 = pool = helper.conv2dReluStride2(pool,conv_s0_weights,conv_s0_biases,isDrop,keep_prop)           
    feature4 = pool = helper.conv2dReluStride2(pool,conv_t0_weights,conv_t0_biases)           
    feature5 = pool = helper.conv2dReluStride2(pool,conv_p0_weights,conv_p0_biases)       
    feature6 = pool = helper.conv2dReluStride2(pool,conv_x0_weights,conv_x0_biases)    
    feature7 = pool = helper.conv2dReluStride2(pool,conv_xx0_weights,conv_xx0_biases)

...
modelName = "./unsupervised/weights/auto_thick.pd"
...
conv_l3_weights = tf.get_variable("l3", shape=[3, 3, depth0, NUM_CHANNELS_In], initializer =tf.contrib.layers.xavier_initializer())
conv_l3_biases = tf.Variable(tf.zeros([NUM_CHANNELS_In]))

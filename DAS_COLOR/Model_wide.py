...
modelName = "./DAS_COLOR/weights/wide10.pd"
LABEL_SIZE_C = 2
ensemble= 10
depth0 = ensemble
...
def inference(inData, train, step):
    ...
    #1/2    
    #if step%3==1: inData= tf.nn.avg_pool(inData,pool_stride2,strides=pool_stride2,padding='SAME')
    #elif step%3==2:inData= tf.nn.avg_pool(inData,pool_stride3,strides=pool_stride3,padding='SAME')
    feature1 = pool = helper.conv2dRelu(inData,conv_l0_weights,conv_l0_biases)
